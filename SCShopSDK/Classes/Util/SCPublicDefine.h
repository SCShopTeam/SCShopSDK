...
//是否是6,7,8模板之后的大屏手机
#define IsLargeScreen         (SCREEN_WIDTH > 375)
...
#define SCNOTI_SEARCH_CELL_CAN_SCROLL    @"SCNOTI_SEARCH_CELL_CAN_SCROLL"
#define SCNOTI_SEARCH_TABLE_CAN_SCROLL  @"SCNOTI_SEARCH_TABLE_CAN_SCROLL"
